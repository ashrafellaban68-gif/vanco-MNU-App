...
# --- GLOBAL DATA ---
drug_db = {
    "Phenytoin": {"Max": "1000 mg/d", "Range": "10-20 mg/L", "SE": "Gingival hyperplasia, Ataxia, Nystagmus.", "Note": "Non-linear Michaelis-Menten kinetics."},
    "Valproic acid": {"Max": "60 mg/kg/d", "Range": "50-100 mg/L", "SE": "Hepatotoxicity, Hair loss, Tremors.", "Note": "Highly protein bound drug."},
    "Carbamazepine": {"Max": "1600 mg/d", "Range": "4-12 mg/L", "SE": "SIADH, Hyponatremia, SJS.", "Note": "Risk of Auto-induction."},
